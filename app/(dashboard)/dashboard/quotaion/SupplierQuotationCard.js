        ...
        <div className="flex gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">
              Posted on : {AllFunctionClient.getDate(quote?.created_at)}
            </p>
          </div>
        </div>
      </div>
          ...
          <>
            {data.map((item, i) => {
              return (
                <div
                  key={i}
                  className="grid grid-cols-[1fr_1fr_2fr_1fr] items-center justify-between py-4"
                >
                  <div>
                  ...
                  <div className="">
                    <p className="text-sm text-gray-900">
                      {item.price > 0
                        ? AllFunctionClient.currency(item.price)
                        : ""}
                    </p>
                    <p className="text-sm text-gray-900">
                      {item.warranty > 0
