...
export default function WarrantyStepper({handleWarranty}) {
  ...
  return (
    <div className="flex flex-col gap-2">
      <label className="text-sm text-[#181818] font-medium">Warranty in Year</label>
