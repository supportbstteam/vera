  ...
  return (
    <div className="relative inline-block">
      ...
      >
        ...
        <span className="float-right"> {isOpen ? <ChevronUp size={16} /> : <ChevronDown size={16} />} </span>
      </button>
      ...
      {isOpen && (
        <ul className="absolute mt-3 w-full grid rounded-md border border-gray-200 bg-white shadow-lg z-3 divide-y divide-gray">
            <li onClick={() => handleSelect("")}
              className="px-4 py-2 text-sm hover:bg-gray-100 cursor-pointer text-black" >Select an option</li>
