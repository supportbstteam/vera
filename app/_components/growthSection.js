...
const GrowthSection = () => {
  return (
    <section className=" bg-black">
      <div className="max-w-7xl mx-auto px-4 py-8 md:py-16 grid items-stretch md:grid-cols-[3fr_2fr_2fr] gap-8 ">
        {/* Left Text */}
        <div className="flex justify-center items-center">
          <div>
            ...
            <p className="text-gray-100">
              VERA helps you connect with serious buyers, increase visibility,
              and win more business — across 16+ European countries.
            </p>
          </div>
        </div>
        {/* Card 1 */}
        <div className="border border-gray-500 rounded-md p-6">
          ...
          <p className="text-sm text-gray-100 mb-4">
            VERA partners with <strong>trusted brands</strong> across Europe to
